...
_PRINTFOOTER2_() {
	...
	if [[ "$CPUABI" = "$CPUABIX86" ]]
	then
		printf "\\e[1;34m%s\\e[0m\\n\\n" "The website https://bbs.archlinux32.org/ has Arch Linux 32 discussion forums.  The website https://wiki.archlinux32.org/ has information about the Arch Linux 32 project" 
	elif [[ "$CPUABI" = "$CPUABIX86_64" ]]
	then
		printf "\\e[1;34m%s\\e[0m\\n\\n" "The website https://bbs.archlinux.org/ has Arch Linux discussion forums.  The webpage https://wiki.archlinux.org/index.php/IRC_channel lists available Arch Linux IRC channels."
	else
		_PRTARFO_
	fi
}
