...
printf "\\e[0;34m\\n%s\\n\\n\e[0m" "If error ' proot info: vpid 1: terminated with signal 4 ' is found, please create a 'qbinds.prs' from file 'bindexample.prs' in directory '$INSTALLDIR/var/binds/' in order to complete the QEMU configuration by running command '${0##*/} r' after creating and editing a 'qbinds.prs' file."
