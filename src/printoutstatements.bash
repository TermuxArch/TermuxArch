...
_PRINTDOWNLOADINGFTCH_() {
    printf '\e]2;%s\n' " 🕛 > 🕓 Downloading the checksum and Arch Linux system image files...  "
...
_PRINT_DOWNLOADING_FTCHIT_() {
    printf '\e]2;%s\n' " 🕛 > 🕓 Downloading the checksum and $IFILE files...  "
...
_PRINTFOOTER_() {
    printf '\e]2;%s\n' "Thank you for using '${0##*/}' to install Arch Linux in Termux PRoot QEMU 📲 "
