...
_MAKESTARTBIN_() {
	...
	printf "\\e[1;32m%s\\e[0;32m%s\\e[1;32m%s\\e[0;32m%s\\n\\n" "$STARTBIN l[ogin]|u[ser] user" "  login as user.  Use " "$STARTBIN c addauser user " "first to create this user and user's home directory."
	printf "\\e[1;32m%s\\e[0;32m%s\\e[1;32m%s\\e[0;32m%s\\n\\n" "$STARTBIN el[ogin]|eu[ser] user" "  use alternate elogin or euser option to login as user.  Use " "$STARTBIN c addauser user " "first to create this user and user's home directory."
