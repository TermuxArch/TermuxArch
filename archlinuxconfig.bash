...
GTFSDPND=(augeas base base-devel bash-completion binutils cpio fuse file gettext gperf hivex intltool jansson libconfig libvirt libxml2 ocaml ocaml-findlib ocaml-bigarray-compat perl perl-libintl-perl perl-module-build perl-string-shellquote perl-sys-virt pcre po4a python qemu-headless rpcsvc-proto supermin valgrind wget xorriso)
