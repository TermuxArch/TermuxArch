...
HLPSTG="Command \${0##*/} accepts 'all', 'noconfirm', 'reverse order build all' and 'small build' as options:
  ...
  r	reverse order build all = like all, but attempts to build all the aur helper packages with passing checksums in reverse in alphabetical order,
...
{ [ -z "\${1:-}" ] && NMKPKG="\$NMKPKC" ; } || { { [[ "\${1//-}" = [Aa]* ]] || [[ "\${1//-}" = [Nn]* ]] || [[ "\${1//-}" = [Ss]* ]] || [[ "\${1//-}" = [Rr]* ]] ; } && NMKPKG="\$NMKPKN" || NMKPKG="\$NMKPKC" && { [[ "\${1//-}" = '/'* ]] || [[ "\${1//-}" = [Hh]* ]] ; } && printf '\\n%s\\n\\n' "\$HLPSTG" && exit ; }
