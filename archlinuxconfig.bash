...
GTFSDPND="augeas base base-devel bash-completion binutils cdrtools cpio gettext gperf hivex jansson libvirt ocaml ocaml-findlib po4a qemu supermin valabind"
NMCMND="\$(uname -m)"
