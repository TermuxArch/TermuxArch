...
_ADDmakeaurpython3xcgf_() { _PREPFILEFTN1_ pythxcgf python3-xcgf python3xcgf "generic data retrieval memoizer that uses an sqlite database to cache data" "{ { pacman-key -l | grep 1D1F0DC78F173680 1>/dev/null ; } || { gpg --keyserver keyserver.ubuntu.com --recv-keys 1D1F0DC78F173680 || gpg --keyserver keyserver.ubuntu.com --recv-keys 1D1F0DC78F173680 ; } ; } &&" ; }

_ADDmakeaurpython3xcpf_() { _PREPFILEFTN1_ pythxcpf python3-xcpf python3xcpf "generic data retrieval memoizer that uses an sqlite database to cache data" "{ { pacman-key -l | grep 1D1F0DC78F173680 1>/dev/null ; } || { gpg --keyserver keyserver.ubuntu.com --recv-keys 1D1F0DC78F173680 || gpg --keyserver keyserver.ubuntu.com --recv-keys 1D1F0DC78F173680 ; } ; } &&" ; }
