...
{ [ -f ./localconfigure ] && _RCSRPTNM_ 15 "cat ./localconfigure" "./localconfigure" "echo \${SRPTNM^^} SIGNAL:  ./localconfigure" ; } || _RCSRPTNM_ 12 "./configure CFLAGS=-fPIC --disable-appliance --disable-daemon" "echo \${SRPTNM^^} SIGNAL:  ./configure CFLAGS=-fPIC --disable-appliance --disable-daemon"
TMRCMDVL="make"
