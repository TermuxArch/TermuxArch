...
## 9) Makes the Arch Linux aur installer 'yay' with TermuxArch command 'makeyay' and more,
...
## Very many hardy thank yous to contributors who are helping and have worked very hard, some for many long hours and more to make this open source resource much better for all!  Please accept a wholehearted thank you for using TermuxArch, and please support TermuxArch with ✨🌟🌟🌠🌟🌟✨ and more!
